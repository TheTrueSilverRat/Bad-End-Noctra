...
/datum/admin_help/proc/mentorissue(key_name = key_name_admin(usr))
	...
	msg += "<font color='red'>My issue has been determined by an administrator to be related to ingame mechanics, For further resolution please use <a href='byond://winset?command=mentorhelp'>MENTOR HELP</span></a>, the <a href='byond://winset?command=wiki'>WIKI</span></a>, or vanderlin questions on Discord if nobody is responding to a meditation..</font>"
