...
/datum/admins/proc/fix_death_area()
	...
	SSblackbox.record_feedback("nested tally", "admin_toggle", 1, list("Fix Death Arena", "Executed")) //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
