...
// --------- ROGUETOWN VALUABLES (ported) -----------

/datum/anvil_recipe/valuables/gold/roguestatue
	name = "Roguetown Gold Statue"
	recipe_name = "a Golden Statue"
	created_item = /obj/item/roguestatue/gold
	craftdiff = 2

/datum/anvil_recipe/valuables/silver/roguestatue
	name = "Roguetown Silver Statue"
	recipe_name = "a Silver Statue"
	created_item = /obj/item/roguestatue/silver
	craftdiff = 2

/datum/anvil_recipe/valuables/iron/roguestatue
	name = "Roguetown Iron Statue"
	recipe_name = "an Iron Statue"
	created_item = /obj/item/roguestatue/iron
	craftdiff = 2

/datum/anvil_recipe/valuables/steel/roguestatue
	name = "Roguetown Steel Statue"
	recipe_name = "a Steel Statue"
	created_item = /obj/item/roguestatue/steel
	craftdiff = 2

/datum/anvil_recipe/valuables/aalloy
	abstract_type = /datum/anvil_recipe/valuables/aalloy
	req_bar = /obj/item/ingot/aalloy
	craftdiff = 2

/datum/anvil_recipe/valuables/aalloy/roguestatue
	name = "Roguetown Aalloy Statue"
	recipe_name = "an Aalloy Statue"
	created_item = /obj/item/roguestatue/aalloy
	craftdiff = 2

/datum/anvil_recipe/valuables/aalloy/rings
	name = "Aalloy Rings 3x"
	recipe_name = "three Aalloy Rings"
...
// Silver gem rings (roguetown gems)
