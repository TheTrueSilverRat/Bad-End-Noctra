...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"Drained Noble Blood" = TRAIT_DEFILED_NOBLE,
		...
		"Merchant Guild Member" = TRAIT_MERCHANT_GUILD,
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_DEATHSIGHT = span_info("I can feel when someone nearby draws the Underlord's attention, a tiny voice whispering 'Someone has died,' in my ear."),
	TRAIT_CABAL = span_purple("In secret, I have studied the ways of His ascension, and know of others of the Cabal."),
	...
	TRAIT_MERCHANT_GUILD = span_info("I am a member of the Merchant Guild and can operate guild trading machines."),
