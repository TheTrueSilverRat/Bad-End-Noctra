...
/datum/status_effect/buff/cranking_soulchurner
	...
	var/list/patron_lines = list(
		/datum/patron/divine/astrata = list("'HIS LIGHT HAS LEFT ME! WHERE AM I?!'", "'SHATTER THIS CONTRAPTION, SO I MAY FEEL HIS WARMTH ONE LAST TIME!'", "'I am royal.. Why did they do this to me...?'"),
		/datum/patron/divine/noc = list("'Colder than moonlight...'", "'No wisdom can reach me here...'", "'Please help me, I miss the stars...'"),
		/datum/patron/divine/necra = list("'They snatched me from his grasp, for eternal torment...'", "'Necra! Please! I am so tired! Release me!'", "'I am lost, lost in a sea of stolen ends.'"),
