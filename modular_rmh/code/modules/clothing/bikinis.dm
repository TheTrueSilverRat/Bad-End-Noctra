...
/obj/item/clothing/armor/corset/hardened
	name = "hardened corset"
	desc = "A rigid corset reinforced with extra leather."
	icon_state = "hcorset"
	item_state = "hcorset"
...
/obj/item/clothing/armor/chainmail/hauberk/bikini/bra
	name = "hauberk bra"
	icon_state = "hauberkbra"
	item_state = "hauberkbra"
	desc = "Try not to get your nipples caught between the chains, now with more coverage, somewhat."
	flags_inv = HIDEBOOB
	is_bra = TRUE
...
/obj/item/clothing/armor/medium/scale/bikini/bra
	...
	icon_state = "scalebra"
	item_state = "scalebra"
	desc = "Overlapping steel plates over the tiddies, almost makes the wearer look like she has silvery fish scales.."
	flags_inv = HIDEBOOB
	is_bra = TRUE
...
/obj/item/clothing/armor/brigandine/bikini
	...
	mob_overlay_icon = 'icons/roguetown/clothing/onmob/armor.dmi'
	sleeved = 'icons/roguetown/clothing/onmob/helpers/sleeves_armor.dmi'
	icon_state = "brigandinebikini"
	item_state = "brigandinebikini"
	allowed_sex = list(FEMALE)
	flags_inv = HIDECROTCH|HIDEBOOB

/obj/item/clothing/armor/brigandine/bikini/bra
	name = "brigandine top"
	desc = "A coat with plates but only topside, concealed inside an exterior fabric. Protects the user from melee impacts and also ranged attacks to an extent."
	icon_state = "brigandinebra"
	item_state = "brigandinebra"
	flags_inv = HIDEBOOB
	is_bra = TRUE
...
/obj/item/clothing/armor/gambeson/light/bikini/bra
	name = "light gambeson top"
	desc = "Thin and the maker skimped on the padding, typically worn by the peasantry to give some protection against cold for... half of the body."
	icon_state = "gambesonlbra"
	item_state = "gambesonlbra"
	flags_inv = HIDEBOOB
	is_bra = TRUE
...
/datum/anvil_recipe/armor/steel/hauberkbikini
	name = "Hauberk Bikini (+Bar)"
	recipe_name = "a Hauberk Bikini"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/steel)
	created_item = /obj/item/clothing/armor/chainmail/hauberk/bikini
	craftdiff = 3

/datum/anvil_recipe/armor/steel/hauberkbra
	name = "Hauberk Bra (+Bar)"
	recipe_name = "a Hauberk Bra"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/steel)
	created_item = /obj/item/clothing/armor/chainmail/hauberk/bikini/bra
	craftdiff = 3

/datum/anvil_recipe/armor/steel/brigadinebikini
	name = "Brigandine Bikini (+Bar x2, +Cloth)"
	recipe_name = "a Brigandine Bikini"
	req_bar = /obj/item/ingot/steel
...
/datum/anvil_recipe/armor/steel/brigadinebra
	name = "Brigandine Top (+Bar x2, +Cloth)"
	recipe_name = "a Brigandine Top"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/steel, /obj/item/ingot/steel, /obj/item/natural/cloth)
	created_item = /obj/item/clothing/armor/brigandine/bikini/bra
	craftdiff = 3

/datum/anvil_recipe/armor/steel/scalemailbikini
	name = "Scalemail Bikini"
	recipe_name = "a Scalemail Bikini"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/steel)
	created_item = /obj/item/clothing/armor/medium/scale/bikini
	craftdiff = 3

/datum/anvil_recipe/armor/steel/scalemailbra
	name = "Scalemail Bra"
	recipe_name = "a Scalemail Bra"
	req_bar = /obj/item/ingot/steel
	additional_items = list(/obj/item/ingot/steel)
	created_item = /obj/item/clothing/armor/medium/scale/bikini/bra
	craftdiff = 3
...
/datum/anvil_recipe/armor/iron/platebikini
	name = "Iron Half-Plate bikini (+Bar x2)"
	recipe_name = "an Iron Half-Plate bikini"
	additional_items = list(/obj/item/ingot/iron, /obj/item/ingot/iron)
	created_item = /obj/item/clothing/armor/plate/iron/bikini

/datum/anvil_recipe/armor/iron/platebra
	name = "Iron Half-Plate Bra (+Bar x2)"
	recipe_name = "an Iron Half-Plate bra"
	additional_items = list(/obj/item/ingot/iron, /obj/item/ingot/iron)
	created_item = /obj/item/clothing/armor/plate/iron/bikini/bra

/datum/anvil_recipe/armor/steel/fullplatebikini
	name = "Full-Plate bikini (+Bar x3)"
	req_bar = /obj/item/ingot/steel
...
/datum/repeatable_crafting_recipe/leather/hcorset
	name = "hardened corset"
	output = /obj/item/clothing/armor/corset/hardened
	requirements = list(/obj/item/natural/hide/cured = 2,
				/obj/item/natural/fibers = 1)
	craftdiff = 4
...
/datum/repeatable_crafting_recipe/conversion/chainkiniconvone
	name = "chainmail bikini"
	output = /obj/item/clothing/armor/chainmail/bikini
	requirements = list(/obj/item/clothing/armor/chainmail = 1)
	attacked_atom = /obj/item/clothing/armor/chainmail

/datum/repeatable_crafting_recipe/conversion/ichainkiniconvone
	name = "maille bikini"
	output = /obj/item/clothing/armor/chainmail/iron/bikini
	requirements = list(/obj/item/clothing/armor/chainmail/iron = 1)
	attacked_atom = /obj/item/clothing/armor/chainmail/iron

/datum/repeatable_crafting_recipe/conversion/ihalfplateconvone
	name = "iron halfplate bikini"
	output = /obj/item/clothing/armor/plate/iron/bikini
	requirements = list(/obj/item/clothing/armor/plate/iron = 1)
	attacked_atom = /obj/item/clothing/armor/plate/iron

/datum/repeatable_crafting_recipe/conversion/ihalfplateconvtwo
	name = "iron halfplate bra"
	output = /obj/item/clothing/armor/plate/iron/bikini/bra
	requirements = list(/obj/item/clothing/armor/plate/iron/bikini = 1)
	attacked_atom = /obj/item/clothing/armor/plate/iron/bikini
...
/datum/repeatable_crafting_recipe/conversion/fullplateconvone
...
/datum/repeatable_crafting_recipe/conversion/fullplateconvtwo
	name = "fullplate bra"
